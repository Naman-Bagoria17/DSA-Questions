...
// { 1, 2, 5, 10, 20, 50, 100, 500, 1000} valued coins/notes IN SORTED ORDER, what is the minimum number
// of coins and/or notes needed to make the change.

// This is greedy approach which is wrong for some test cases
// This questions is of DP and backtracking
#include <bits/stdc++.h>
using namespace std;
int main()
{
